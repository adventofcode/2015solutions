...
defmodule Advent23p1 do
  ...
  def calculate do
    ...
    Stream.transform([ prog, 0, 0, 0 ], fn(_,acc) -> do_work(acc) end) |>
    Enum.to_list |>
    Enum.fetch!(-1)
  end
...
IO.puts "At end of program, Register b=" <> Integer.to_string(Advent23p1.calculate)
